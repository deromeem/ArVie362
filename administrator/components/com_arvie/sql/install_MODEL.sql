...
INSERT INTO `abonnements` (`id`, `abonne`, `suivi`, `date`, `alias`, `published`, `created`, `created_by`, `modified`, `modified_by`, `hits`) VALUES
...
INSERT INTO `discussions` (`id`, `nom`, `alias`, `published`, `created`, `created_by`, `modified`, `modified_by`, `hits`) VALUES
...
INSERT INTO `evenements` (`id`, `publication`, `date_event`, `lieu`, `alias`, `published`, `created`, `created_by`, `modified`, `modified_by`, `hits`) VALUES
...
INSERT INTO `groupes` (`id`, `groupe_parent`, `nom`, `est_groupe_interet`, `est_public`, `alias`, `published`, `created`, `created_by`, `modified`, `modified_by`, `hits`) VALUES
...
--
-- Déchargement des données de la table `groupe_utilisateur_map`
--

INSERT INTO `groupe_utilisateur_map` (`id`, `utilisateur`, `groupe`, `date_deb`, `date_fin`, `role`, `alias`, `published`, `created`, `created_by`, `modified`, `modified_by`, `hits`) VALUES
...
INSERT INTO `messages` (`id`, `auteur`, `discussion`, `contenu`, `alias`, `published`, `created`, `created_by`, `modified`, `modified_by`, `hits`) VALUES
...
--
-- Déchargement des données de la table `metier_groupe_map`
--
...
INSERT INTO `parrains` (`id`, `parrain`, `filleul`, `date_deb`, `date_fin`, `alias`, `published`, `created`, `created_by`, `modified`, `modified_by`, `hits`) VALUES
...
INSERT INTO `roles` (`id`, `label`, `alias`, `published`, `created`, `created_by`, `modified`, `modified_by`, `hits`) VALUES
(0, '-', '-', 0, '2018-04-26 11:00:00', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Déchargement des données de la table `utilisateur_discu_map`
--

INSERT INTO `utilisateur_discu_map` (`id`, `utilisateur`, `discussion`, `est_admin`, `alias`, `published`, `created`, `created_by`, `modified`, `modified_by`, `hits`) VALUES
...
--
-- Déchargement des données de la table `utilisateur_even_map`
--

INSERT INTO `utilisateur_even_map` (`id`, `participant`, `evenement`, `alias`, `published`, `created`, `created_by`, `modified`, `modified_by`, `hits`) VALUES
...
--
ALTER TABLE `evenements`
  ADD CONSTRAINT `evenements_ibfk_1` FOREIGN KEY (`publication`) REFERENCES `publications` (`id`);
...
--
ALTER TABLE `utilisateur_even_map`
  ADD CONSTRAINT `utilisateur_even_map_ibfk_1` FOREIGN KEY (`participant`) REFERENCES `utilisateurs` (`id`),
  ADD CONSTRAINT `utilisateur_even_map_ibfk_2` FOREIGN KEY (`evenement`) REFERENCES `evenements` (`id`);
COMMIT;
