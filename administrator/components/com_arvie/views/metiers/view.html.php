...
class ArvieViewMetiers extends JViewLegacy
{
	function display($tpl = null) 
	{
		...
		ArvieHelper::addSubmenu('metiers');
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_ARVIE')." : ".JText::_('COM_ARVIE_METIERS'));
		
		// affiche les boutons d'action
		JToolBarHelper::addNew('metier.add');
		JToolBarHelper::editList('metier.edit');
		JToolBarHelper::deleteList('Etes vous sûr ?', 'metiers.delete');
		JToolbarHelper::publish('metiers.publish', 'JTOOLBAR_PUBLISH', true);
		JToolbarHelper::unpublish('metiers.unpublish', 'JTOOLBAR_UNPUBLISH', true);
		JToolbarHelper::archiveList('metiers.archive');
		JToolbarHelper::checkin('metiers.checkin');
		JToolbarHelper::trash('metiers.trash');
	...
	protected function prepareSideBar()
	{
		...
		JHtmlSidebar::setAction('index.php?option=com_arvie&view=metiers');
