...
class ArvieModelEvenement extends JModelAdmin
{
	protected $_compo = 'com_arvie';
	protected $_context = 'evenement';
	public $typeAlias = 'com_arvie.evenement';
	
	// Surcharges des m�thodes de la classe m�re pour :
	
	// 1) d�finir la table de soutien � utiliser
	public function getTable($type = 'Evenement', $prefix = 'ArvieTable', $config = array()) 
	{
