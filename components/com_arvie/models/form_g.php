...
require_once JPATH_COMPONENT_ADMINISTRATOR.'/models/groupe.php';

class ArvieModelForm_g extends ArvieModelGroupe
{
	...
	{
		$itemId = (int) (!empty($itemId)) ? $itemId : $this->getState('groupe.id');
