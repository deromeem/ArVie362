...
$uriCompoDetail = JURI::base(true)."/index.php?option=com_arvie&view=evenement&id=";
...
<form action="<?php echo JUri::getInstance()->toString(); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div class="form-inline form-inline-header">
		...
		<div class="btn-group pull-left">
			<a href="<?php echo JRoute::_('index.php?option=com_arvie&view=form_e&layout=edit'); ?>" class="btn" role="button"><span class="icon-plus"></span></a>
		</div>	
		...
		<tbody>
			<?php foreach($this->items as $i => $item) : ?>
				<tr class="row<?php echo $i % 2; ?>">
					...
					<!-- <td><?php echo JHtml::_('jgrid.published', $item->published, $i, 'evenements.', true); ?></td> -->
					<td><?php echo $item->evenement_parent_nom ?></td>
					<td><?php if($item->est_evenement_interet)
										{echo 'Interêt';} 
									else{echo 'Classe';}
						?></td>
