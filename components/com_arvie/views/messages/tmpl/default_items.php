...
$uriCompoDetail = JURI::base(true)."/index.php?option=com_arvie&view=message&id=";
...
<form action="<?php echo JUri::getInstance()->toString(); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div class="form-inline form-inline-header">
		...
		<div class="btn-group pull-left">
			<a href="<?php echo JRoute::_('index.php?option=com_arvie&view=form_m&layout=edit'); ?>" class="btn" role="button"><span class="icon-plus"></span></a>
		</div>	
	...
	<table class="table table-striped" id="articleList">
		<thead>
			<tr>
				...
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_ARVIE_GROUPES_GROUPES_PARENT'), 'message_parent_nom', $listDirn, $listOrder) ?>
				</th>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_ARVIE_GROUPES_EST_GROUPE_INTERET'), 'est_message_interet', $listDirn, $listOrder) ?>
				</th>
		...
		<tbody>
			<?php foreach($this->items as $i => $item) : ?>
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td><?php echo $item->message_parent_nom ?></td>
					<td><?php if($item->est_message_interet)
										{echo 'Interêt';} 
									else{echo 'Classe';}
						?></td>
