...
<script type="text/javascript">
	...
	{
		if (task == 'utilisateur_discu_map.cancel' || document.formvalidator.isValid(document.id('arvie-form')))
		{
...
<form action="<?php echo JRoute::_('index.php?option=com_arvie&layout=edit&id='.(int) $this->item->id); ?>"
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'utilisateur_discu_map')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'utilisateur_discu_map', JText::_('COM_ARVIE_UTILISATEUR_DISCU_MAP')); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="form-vertical">
				...
				<div class="control-group">
					<div class="control-label"><?php echo $this->form->getLabel('est_admin'); ?></div>
					<div class="controls"><?php echo $this->form->getInput('est_admin'); ?></div>
				</div>
			</div>
		</div>
