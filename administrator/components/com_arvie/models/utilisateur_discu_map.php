...
class ArvieModelUtilisateur_discu_map extends JModelAdmin
{
	protected $_compo = 'com_arvie';
	protected $_context = 'utilisateur_discu_map';
	public $typeAlias = 'com_arvie.utilisateur_discu_map';
	
	// Surcharges des m�thodes de la classe m�re pour :
	
	// 1) d�finir la table de soutien � utiliser
	public function getTable($type = 'utilisateur_discu_map', $prefix = 'ArvieTable', $config = array()) 
	{
