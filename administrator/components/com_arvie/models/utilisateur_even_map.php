...
class ArvieModelUtilisateur_even_map extends JModelAdmin
{
	protected $_compo = 'com_arvie';
	protected $_context = 'utilisateur_even_map';
	public $typeAlias = 'com_arvie.utilisateur_even_map';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'utilisateur_even_map', $prefix = 'ArvieTable', $config = array()) 
	{
