...
class ArvieModelMetier_groupe_map extends JModelAdmin
{
	protected $_compo = 'com_arvie';
	protected $_context = 'metier_groupe_map';
	public $typeAlias = 'com_arvie.metier_groupe_map';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Metier_groupe_map', $prefix = 'ArvieTable', $config = array()) 
	{
