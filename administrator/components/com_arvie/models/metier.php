...
class ArvieModelMetier extends JModelAdmin
{
	protected $_compo = 'com_arvie';
	protected $_context = 'metier';
	public $typeAlias = 'com_arvie.metier';
	
	// Surcharges des méthodes de la classe mére pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Metier', $prefix = 'ArvieTable', $config = array()) 
	{
