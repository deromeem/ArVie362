...
class ArvieModelRole extends JModelAdmin
{
	protected $_compo = 'com_arvie';
	protected $_context = 'role';
	public $typeAlias = 'com_arvie.role';
	
	// Surcharges des m�thodes de la classe m�re pour :
	
	// 1) d�finir la table de soutien � utiliser
	public function getTable($type = 'role', $prefix = 'ArvieTable', $config = array()) 
	{
