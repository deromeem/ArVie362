		...
		<form action="<?php echo JRoute::_('index.php?option=com_arvie&a_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
			...
			<div class="form-inline form-inline-header">
				<div class="btn-group pull-left">
					...
					<h2><?php echo JText::_('COM_ARVIE_DISCUSSION')." ".($isNew ? JText::_('COM_ARVIE_ADD_PAR'): JText::_('COM_ARVIE_MODIF_PAR')); ?></h2>
				</div>
			...
			<fieldset>
				<ul class="nav nav-tabs">
					<li><a href="#discussion" data-toggle="tab"><?php echo JText::_('COM_ARVIE_DISCUSSION'); ?></a></li>
				</ul>
					...
					<div class="tab-pane active" id="discussion">
						<table class="table">
							<tbody>
								...
								<tr>
									<td width="20%" class="nowrap right">
										<div class="control-label"><?php echo $this->form->getLabel('admin'); ?></div>
									</td>
									<td width="80%">
										<div class="controls"><?php echo $this->form->getInput('admin'); ?></div>
									</td>
								</tr>
							</tbody>
						</table>
