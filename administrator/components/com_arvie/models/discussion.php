...
class ArvieModelDiscussion extends JModelAdmin
{
	protected $_compo = 'com_arvie';
	protected $_context = 'discussion';
	public $typeAlias = 'com_arvie.discussion';
	
	// Surcharges des méthodes de la classe mére pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Discussion', $prefix = 'ArvieTable', $config = array()) 
	{
